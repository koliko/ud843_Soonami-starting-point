...
//    private static final String USGS_REQUEST_URL = "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2012-01-01&endtime=2012-12-01&minmagnitude=6";
    private static final String USGS_REQUEST_URL = "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&&starttime=2018-01-01&endtime=2018-10-01&minmagnitude=7";
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                if(urlConnection.getResponseCode() == 200){
                    ...
                    Log.e(LOG_TAG ,"error responds code"+urlConnection.getResponseCode());
                }
            } catch (IOException e) {
